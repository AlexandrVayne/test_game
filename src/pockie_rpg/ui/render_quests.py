...
class QuestRendererMixin:
    ...
    def _place_quest_arrow(self, quest_id: str) -> None:
        """Явно поставить стрелку над целью квеста (используется _quest_go_to)."""
        from pockie_rpg.config import QUEST_ARROW_SEC
        self._quest_arrow_quest = quest_id
        self._quest_arrow_timer = QUEST_ARROW_SEC
