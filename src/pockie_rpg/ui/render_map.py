...
class MapRendererMixin:
    ...
    def _f_map_level(self) -> pygame.font.Font:
        return self._su_font(*_FS_MAP_LEVEL)

    def _f_map_soon(self) -> pygame.font.Font:
        return self._su_font(*_FS_MAP_SOON)

    def _f_map_btn_sm(self) -> pygame.font.Font:
        return self._su_font(*_FS_MAP_BTN_SM)

    def _f_map_btn_md(self) -> pygame.font.Font:
        return self._su_font(*_FS_MAP_BTN_MD)

    def _f_map_gold(self) -> pygame.font.Font:
        return self._su_font(*_FS_MAP_GOLD)

    def _f_map_label(self) -> pygame.font.Font:
        return self._su_font(*_FS_MAP_LABEL)
    ...
    def _f_map_banner(self) -> pygame.font.Font:
        return self._su_font(*_FS_BANNER)
    ...
    def _f_map_letter(self) -> pygame.font.Font:
        return self._su_font(*_FS_SKILLS_BTN_LETTER)
