...
Opens via F8 hotkey or a button in the inventory modal (F9 с Stage 208
занял фейсинг-оверлей).
...
class TestPanelRendererMixin:
    ...
    def _toggle_test_panel(self) -> None:
        """Stage 109 — Toggle test panel visibility (F8 hotkey с Stage 208)."""
    ...
    def _load_from_save_slot(self, n: int) -> None:
        """Stage 171 — B1: dev-загрузка слота сейва (F8, только на карте).
